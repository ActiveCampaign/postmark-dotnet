...
### Usage
Please see the [wiki](https://github.com/jptoto/postmark-dotnet/wiki) for instructions about sending email, using the bounce api, and additional sending options.
